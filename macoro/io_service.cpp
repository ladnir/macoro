...
#include "macoro/on_scope_exit.h"
...
{
#if MACORO_WINDOWS_OS
	macoro::detail::win32::safe_handle create_io_completion_port(std::uint32_t concurrencyHint)
	{
		...
		return macoro::detail::win32::safe_handle{ handle };
	}

	macoro::detail::win32::safe_handle create_auto_reset_event()
	{
		...
		return macoro::detail::win32::safe_handle{ eventHandle };
	}

	macoro::detail::win32::safe_handle create_waitable_timer_event()
	{
...
class macoro::io_service::timer_queue
{
public:
	...
	void enqueue_timer(macoro::io_service::timed_schedule_operation* timer) noexcept;

	void dequeue_due_timers(
		time_point currentTime,
		macoro::io_service::timed_schedule_operation*& timerList) noexcept;
...
private:
	...
	struct timer_entry
	{
		timer_entry(macoro::io_service::timed_schedule_operation* timer)
			: m_dueTime(timer->m_resumeTime)
			, m_timer(timer)
		{}

		time_point m_dueTime;
		macoro::io_service::timed_schedule_operation* m_timer;
	};
	...
	macoro::io_service::timed_schedule_operation* m_overflowTimers;

};

macoro::io_service::timer_queue::timer_queue() noexcept
	: m_timerEntries()
	, m_overflowTimers(nullptr)
{}

macoro::io_service::timer_queue::~timer_queue()
{
	assert(is_empty());
}

bool macoro::io_service::timer_queue::is_empty() const noexcept
{
	return m_timerEntries.empty() && m_overflowTimers == nullptr;
}

macoro::io_service::timer_queue::time_point
macoro::io_service::timer_queue::earliest_due_time() const noexcept
{
...
void macoro::io_service::timer_queue::enqueue_timer(
	macoro::io_service::timed_schedule_operation* timer) noexcept
{
	try
	{
...
void macoro::io_service::timer_queue::dequeue_due_timers(
	time_point currentTime,
	macoro::io_service::timed_schedule_operation*& timerList) noexcept
{
...
void macoro::io_service::timer_queue::remove_cancelled_timers(
	macoro::io_service::timed_schedule_operation*& timerList) noexcept
{
...
class macoro::io_service::timer_thread_state
{
public:
...
macoro::io_service::io_service()
	: io_service(0)
{
}

macoro::io_service::io_service(std::uint32_t concurrencyHint)
	: m_threadState(0)
	, m_workCount(0)
#if MACORO_WINDOWS_OS
...
macoro::io_service::schedule_operation macoro::io_service::schedule() noexcept
{
	return schedule_operation{ *this };
}

std::uint64_t macoro::io_service::process_events()
{
...
std::uint64_t macoro::io_service::process_pending_events()
{
	std::uint64_t eventCount = 0;
	if (try_enter_event_loop())
	{
...
std::uint64_t macoro::io_service::process_one_event()
{
	std::uint64_t eventCount = 0;
	if (try_enter_event_loop())
	{
...
std::uint64_t macoro::io_service::process_one_pending_event()
{
	std::uint64_t eventCount = 0;
	if (try_enter_event_loop())
	{
...
void macoro::io_service::stop() noexcept
{
...
bool macoro::io_service::is_stop_requested() const noexcept
{
	return (m_threadState.load(std::memory_order_acquire) & stop_requested_flag) != 0;
}

void macoro::io_service::notify_work_started() noexcept
{
	m_workCount.fetch_add(1, std::memory_order_relaxed);
}

void macoro::io_service::notify_work_finished() noexcept
{
...
#endif // MACORO_WINDOWS_OS

void macoro::io_service::schedule_impl(schedule_operation* operation) noexcept
{
#if MACORO_WINDOWS_OS
...
void macoro::io_service::try_reschedule_overflow_operations() noexcept
{
#if MACORO_WINDOWS_OS
...
bool macoro::io_service::try_enter_event_loop() noexcept
{
...
void macoro::io_service::exit_event_loop() noexcept
{
	m_threadState.fetch_sub(active_thread_count_increment, std::memory_order_relaxed);
}

bool macoro::io_service::try_process_one_event(bool waitForEvent)
{
#if MACORO_WINDOWS_OS
...
void macoro::io_service::post_wake_up_event() noexcept
{
#if MACORO_WINDOWS_OS
...
macoro::io_service::timer_thread_state*
macoro::io_service::ensure_timer_thread_started()
{
...
void macoro::io_service::timer_thread_state::request_timer_cancellation() noexcept
{
...
void macoro::io_service::timer_thread_state::run() noexcept
{
#if MACORO_WINDOWS_OS
...
void macoro::io_service::timer_thread_state::wake_up_timer_thread() noexcept
{
#if MACORO_WINDOWS_OS
...
void macoro::io_service::schedule_operation::await_suspend(
...
macoro::io_service::timed_schedule_operation::timed_schedule_operation(
	io_service& service,
	std::chrono::high_resolution_clock::time_point resumeTime,
	macoro::cancellation_token cancellationToken) noexcept
...
bool macoro::io_service::timed_schedule_operation::await_ready() const noexcept
{
	return m_cancellationToken.is_cancellation_requested();
}

void macoro::io_service::timed_schedule_operation::await_suspend(
...
void macoro::io_service::timed_schedule_operation::await_resume()
{
