...
namespace macoro
{
	...
	public:
		...
		/// immediately.
		/// The co_await operation will throw macoro::operation_cancelled if
	...
	public:
		...
		{
			await_suspend(coroutine_handle<>(awaiter));
		}
#endif
	...
	private:
		...
		optional<macoro::cancellation_registration> m_cancellationRegistration;
...
macoro::io_service::timed_schedule_operation
macoro::io_service::schedule_after(
