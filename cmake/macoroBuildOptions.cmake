...
if(DEFINED MACORO_OPTIONAL_LITE)
    message("setting MACORO_OPTIONAL_LITE_V=MACORO_OPTIONAL_LITE=${MACORO_OPTIONAL_LITE}")
    set(MACORO_OPTIONAL_LITE_V ${MACORO_OPTIONAL_LITE})
else()  
    if(${MACORO_CPP_VER} EQUAL 14)
        message("setting MACORO_OPTIONAL_LITE_V=ON due to cpp=14")
...
if(DEFINED MACORO_VARIANT_LITE)
    message("setting MACORO_VARIANT_LITE_V=MACORO_VARIANT_LITE=${MACORO_VARIANT_LITE}")

    set(MACORO_VARIANT_LITE_V ${MACORO_VARIANT_LITE})
else()

    if(${MACORO_CPP_VER} EQUAL 14)
        message("setting MACORO_VARIANT_LITE_V=ON due to cpp=14")
